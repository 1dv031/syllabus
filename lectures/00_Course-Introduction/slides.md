...
| | | |
|-|-|-|
| <!-- {_class="table-cell"} -->  ![Ola](https://www.gravatar.com/avatar/b47109ad8c128221c9dd060d15c89cc9.jpg?s=80) <!-- {_class="grayscale"} --> | <!-- {_class="table-cell"} --> Ola Flygt (Course manager) |
| <!-- {_class="table-cell"} -->  ![Haofei](https://www.gravatar.com/avatar/b47109ad8c128221c9dd060d15c89cc9.jpg?s=80) <!-- {_class="grayscale"} --> | <!-- {_class="table-cell"} --> Haofei Yan (Teaching assistant) |
| <!-- {_class="table-cell"} -->  ![Maxim](https://mymoodle.lnu.se/pluginfile.php/1056489/user/icon/essential/f1?rev=12820559?s=80) <!-- {_class="grayscale"} --> | <!-- {_class="table-cell"} --> Maxim Kravchenko (Teaching assistant) |
...
* different operation methods for operating systems and services
